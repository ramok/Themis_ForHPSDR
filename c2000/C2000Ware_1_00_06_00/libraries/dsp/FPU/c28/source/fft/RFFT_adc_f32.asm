...
;; FUNCTIONS:
;;
;;    void RFFT_adc_f32 (RFFT_ADC_F32_STRUCT_Handle)
;;
;;     where RFFT_ADC_F32_STRUCT_Handle is defined as:
;;     typedef RFFT_F32_STRUCT* RFFT_ADC_F32_STRUCT_Handle;
;;
;;    and where RFFT_ADC_F32_STRUCT is a structure defined as:
;;
;;     typedef struct {
;;          uint16_t    *InBuf;
;;          void        *Tail;
...
;===========================================================================
; Function: void RFFT_adc_f32(RFFT_ADC_F32_STRUCT_Handle)
;===========================================================================
; RFFT_adc_f32_Stages1and2and3andBitReverse(RFFT_ADC_F32_STRUCT_Handle);
; RFFT_adc_f32_Stages4andUp(RFFT_ADC_F32_STRUCT_Handle);
;
        .global  _RFFT_adc_f32
           .sect    .text
...
;===========================================================================
; Function: void rfft_adc_f32_Stages1and2and3andBitReverse(
;                                   RFFT_ADC_F32_STRUCT_Handle)
;===========================================================================
;---------------------------------------------------------------------------
;
; DESCRIPTION:
...
;===========================================================================
; Function: void rfft_f32_Stages4andUp(RFFT_ADC_F32_STRUCT_Handle)
;===========================================================================
;===========================================================================
;
; ON ENTRY:
...
FRMSZ           .set        COSSINBUF
       ...
       .global _rfft_adc_f32_Stages4andUp
       .text

_rfft_adc_f32_Stages4andUp:
