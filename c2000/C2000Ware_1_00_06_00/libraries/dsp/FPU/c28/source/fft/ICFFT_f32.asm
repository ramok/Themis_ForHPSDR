...
;; D. Alter     Jul 06, 2011
;; 
;; This function computes an inverse complex FFT.  The input buffer must be
;; aligned to a multiple of the FFT size.  If it is not aligned then the
;; output buffer will yield invalid results.
;; 
...
;; FUNCTIONS:
;;
;;    void ICFFT_f32 (CFFT_F32_STRUCT_Handle)
;;
...
;===========================================================================
; Function: void ICFFT_f32(CFFT_F32_STRUCT *cfft)
;===========================================================================
