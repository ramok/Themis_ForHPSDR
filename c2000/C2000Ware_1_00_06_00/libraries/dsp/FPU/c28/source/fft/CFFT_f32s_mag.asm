;;#############################################################################
;;! \file source/fft/CFFT_f32s_mag.asm
;;!
;;! \brief  Complex FFT scaled magnitude calculations
...
;===========================================================================
; Function: void CFFT_f32s_mag(CFFT_F32_STRUCT_Handle)
;===========================================================================

    .global _CFFT_f32s_mag
    .text
...
;--- Calculate the scale factor
        ...
        B _cfft_f32s_mag_end, LEQ     ; If stages < 3, end the function
