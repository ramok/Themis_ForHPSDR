//#############################################################################
//! \file /2837x_WindowedRFFT/main.c
//!
//! \brief  Demo code for the Real Windowed FFT
//! \author Vishal Coelho
//! \date   02/19/2015
//! 
//! This example shows how to compute the FFT on an N point real data, with
...
//*****************************************************************************
//!
//! \brief main routine for the Real FFT (windowed) example
//! \return returns a 1
//!
...
//! against MATLAB code under 2837x_WindowedRFFT/matlab/RFFTWindowedforC28x.m
//!
...
int16_t main(void)
{
    ...
    hnd_rfft->PhaseBuf  = &RFFTphaseBuff[0];//Phase buffer
