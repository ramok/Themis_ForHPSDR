//#############################################################################
//! \file /2837x_vcu2_viterbi_k4cr12/main.c
//!
//! \brief  Demo code for Viterbi K=4 CR=1/2 routine(VCU)
//!
//! \date   July 25, 2013
//! 
...
//!
//! \defgroup VITERBI_EXAMPLES Viterbi Decoder K=4, CR=1/2 Example
...
const int32_t BMSELInit = 0x00005140;
...
//!
//! \brief main routine for the Viterbi decoder K=4 CR=1/2
//! \return returns a 1
//!
//! This example shows how to use the vcu2 supported VITERBI routines from the
...
int main( void )
{
    ...
    //! \f$ G_{0} = 1 + D_{2} + D_{3}\f$
    //! \f$ G_{1} = 1 + D_{1} + D_{2} + D_{3}\f$
	...
	VITERBI_DECODER.run               =(void(*)(void *))VITERBI_DECODER_runK4CR12;
	VITERBI_DECODER.init			  =(void(*)(void *))VITERBI_DECODER_initK4CR12;
	VITERBI_DECODER.rescale		      =(void(*)(void *))VITERBI_DECODER_rescaleK4CR12;
