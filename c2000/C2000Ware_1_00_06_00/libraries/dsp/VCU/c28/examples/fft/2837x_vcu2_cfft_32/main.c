//#############################################################################
//! \file /2837x_vcu2_cfft_32/main.c
//!
//! \brief  Demo code for the 32 sample CFFT routine(VCU)
//!
//! \date   July 16, 2013
//! 
//! This example shows how to use the vcu2 supported CFFT and ICFFT routines 
//! from the library
//!
//
//  Group:             C2000
...
//!
//! \defgroup CFFT_EXAMPLES Complex Fast Fourier Transform (N = 32) Example

//!
//! \ingroup CFFT_EXAMPLES
// @{
...
// \brief Expected Output of the FFT
//
...
//!
//! \brief main routine for the 32-sample CFFT example
//! \return returns a 1
//!
...
int main( void )
{
	...
	CFFT.init = (void (*)(void *))CFFT_init32Pt;
	CFFT.run  = (void (*)(void *))CFFT_run32Pt;
    ...
    //!
    //*************************************************************************
	// Step 4: Verify the result of the FFT
    ...
    CFFT.run  = (void (*)(void *))ICFFT_run32Pt;
