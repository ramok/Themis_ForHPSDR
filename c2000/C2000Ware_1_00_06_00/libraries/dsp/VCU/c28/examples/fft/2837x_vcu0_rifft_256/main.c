//#############################################################################
//! \file /2837x_vcu0_rifft_256/main.c
//!
//! \brief  Demo code for the 256 sample Real Inverse FFT routine(VCU)
//!
//! \date   July 23, 2013
//! 
...
//!
//! \addtogroup VCU0_RIFFT_EXAMPLES Real Fast Fourier Transform (N = 256) Example
...
int main( void )
{
	...
	// Step 3: Verify the result
	  for (k=0; k<DATA_LENGTH; k++)	  {
		  if (abs(RIFFT16_256p_out_data[k] - RIFFT16_256p_in_data[k]) > EPSILON){
			  fail++;
		  }else{
			  pass++;
		  }
