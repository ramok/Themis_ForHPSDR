//#############################################################################
//! \file /2837x_vcu0_cfft_256/main.c
//!
//! \brief  Demo code for the 256 sample CFFT routine(VCU)
//!
//! \date   July 23, 2013
//! 
...
//!
//! \addtogroup VCU0_CFFT_EXAMPLES Complex Fast Fourier Transform (N = 256) Example
...
// globals
//*****************************************************************************
cfft16_t fft = cfft16_256P_DEFAULTS;
...
int main( void )
{
	...
	// Step 1: Initialize CFFT object
	  fft.ipcbptr = (int *)CFFT16_256p_in_data + 0;
	...
	// Step 3: Verify the result
	  for (k=0; k<DATA_LENGTH; k++)	  {
		  if (CFFT16_256p_out_data[k] != CFFT16_256p_in_data[k]){
			  fail++;
		  }else{
			  pass++;
		  }
