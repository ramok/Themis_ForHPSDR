//#############################################################################
//! \file /2837x_vcu0_rfft_128/main.c
//!
//! \brief  Demo code for the 128 sample RFFT routine(VCU)
//!
//! \date   July 23, 2013
//! 
...
//!
//! \addtogroup VCU0_RFFT_EXAMPLES Real Fast Fourier Transform (N = 128) Example
...
int main( void )
{
	...
	// Step 1: Initialize CFFT object
	  fft.ipcbptr = (int *)RFFT16_128p_in_data + 0;
	...
	// Step 3: Verify the result
	  for (k=0; k<DATA_LENGTH; k++)	  {
		  if (abs(RFFT16_128p_out_data[k] - RFFT16_128p_in_data[k]) > EPSILON){
			  fail++;
		  }else{
			  pass++;
		  }
