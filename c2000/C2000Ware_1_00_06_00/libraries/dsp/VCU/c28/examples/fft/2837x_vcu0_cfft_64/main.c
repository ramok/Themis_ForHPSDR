//#############################################################################
//! \file /2837x_vcu0_cfft_64/main.c
//!
...
//!
//! \addtogroup VCU0_CFFT_EXAMPLES Complex Fast Fourier Transform (N = 64) Example
...
// globals
//*****************************************************************************
cfft16_t fft = cfft16_64P_DEFAULTS;
...
int main( void )
{
	...
	// Step 1: Initialize CFFT object
	  fft.ipcbptr = (int *)CFFT16_64p_in_data + 0;
	...
	// Step 3: Verify the result
	  for (k=0; k<DATA_LENGTH; k++)	  {
		  if (CFFT16_64p_out_data[k] != CFFT16_64p_in_data[k]){
			  fail++;
		  }else{
			  pass++;
		  }
