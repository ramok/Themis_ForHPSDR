//#############################################################################
//! \file /2837x_vcu0_rifft_64/main.c
//!
//! \brief  Demo code for the 64 sample Real Inverse FFT routine(VCU)
//!
//! \date   July 23, 2013
//! 
...
//!
//! \addtogroup VCU0_RIFFT_EXAMPLES Real Fast Fourier Transform (N = 64) Example
...
// globals
//*****************************************************************************
cfft16_t fft = rifft16_64P_DEFAULTS;
...
//!
//! \brief main routine for the 64-sample RFFT example
//! \return returns a 1
//!
//! This example shows how to use the vcu0 supported CFFT routines from the
...
int main( void )
{
	...
	// Step 1: Initialize CFFT object
	  fft.ipcbptr = (int *)RIFFT16_64p_in_data + 0;
	...
	// Step 3: Verify the result
	  for (k=0; k<DATA_LENGTH; k++)	  {
		  if (abs(RIFFT16_64p_out_data[k] != RIFFT16_64p_in_data[k]) > EPSILON){
			  fail++;
		  }else{
			  pass++;
		  }
