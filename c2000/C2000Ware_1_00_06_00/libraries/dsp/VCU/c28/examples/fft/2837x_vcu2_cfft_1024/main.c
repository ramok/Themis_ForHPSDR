//#############################################################################
//! \file /2837x_vcu2_cfft_1024/main.c
//!
//! \brief  Demo code for the 1024 sample CFFT routine(VCU)
//!
//! \date   July 23, 2013
//! 
...
#define ERR_EPSILON	5
#define ERR_IFFT_EPSILON	128
//*****************************************************************************
// globals
//*****************************************************************************
#ifdef __cplusplus
...
int main( void )
{
    ...
    CFFT.run  = (void (*)(void *))ICFFT_run1024Pt;
