//#############################################################################
//! \file /2837x_vcu0_crc_wTables/main.c
//!
...
//! -# the tables are included in the c28x_vcu0_crcTables_library(_fpu32).lib,
//!    the user must add the search path to the library to the linker options
...
//! \page VCU0_CRC_PAGE (Cyclic Redundancy Check)
//! 
...
int main( void )
{
	...
	//Step 2: Run the C lookup routines
