...
// Tests 6-10 are "FLASH" build tests only and will not work in the "RAM" build configuration
...
// N = 4096 requires 2 buffers of size 16384 words each and another 16384 words of ebss space to work
...
// Tests 14-18 are "FLASH" build tests only and will not work in the "RAM" build configuration
...
// N = 4096 requires 2 buffers of size 16384 words each and another 16384 words of ebss space to work
//#define TEST_18				(1 << 17) // 4096 pt FFT mag, golden result from MATLAB "FixedPointCFFT.m"

#define RUN_TEST		 	TEST_16
