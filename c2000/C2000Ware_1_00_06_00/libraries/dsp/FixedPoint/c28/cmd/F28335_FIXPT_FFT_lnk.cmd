...
//          F28335 and depending on the active build configuration(RAM or FLASH)
...
// $Release Date: Thu Oct 18 15:57:21 CDT 2018 $
...
/* BEGIN is used for the "boot to SARAM" bootloader mode      */
   ...
   RAML0L1     : origin = 0x008000,  length = 0x002000     /* on-chip RAM blocks L0-L1*/
...
/* corrupting this area during the debug process              */
   ...
   RAML2L3     : origin = 0x00A000, length = 0x001400     /* on-chip RAM block L2-L3*/
   RAML4       : origin = 0x00B400, length = 0x001800     /* on-chip RAM block L5 */
   RAML5       : origin = 0x00CC00, length = 0x000400     /* on-chip RAM block L5 */
   RAML61      : origin = 0x00D000, length = 0x001600     /* on-chip RAM block L6 */
   RAML62      : origin = 0x00E600, length = 0x001600     /* on-chip RAM block L6 */
...
#if defined(RAM)
   ramfuncs			   : > RAML0L1,    PAGE = 0
   .cinit              : > RAML0L1,    PAGE = 0
   .pinit              : > RAML0L1,    PAGE = 0
   .text               : > RAML0L1,    PAGE = 0
   .econst             : > RAML0L1,    PAGE = 0
   .switch             : > RAML0L1,    PAGE = 0
   csmpasswds          : > CSM_PWL,    PAGE = 0, TYPE = DSECT /* Dummy Sections for RAM builds */
   csm_rsvd            : > CSM_RSVD,   PAGE = 0, TYPE = DSECT /* Dummy Sections for RAM builds */
   /* the csm_<> sections were declared as dummy sections for the RAM build, else
   the flash tool gets invoked to erase all sectors */
#elif defined(FLASH)
...
#error Add either "RAM" or "FLASH" to C2000 Linker -> Advanced Options -> Command File Preprocessing -> --define
   ...
   /*  FFT_ALIGN must be defined in the project properties under
    ...
    The input buffer must be aligned to 4N (2N long words) words. For e.g.
    N = 64, --define=FFT_ALIGN=0x100 (i.e. 256)*/
   FFTipcb             : > RAML61, align(FFT_ALIGN), PAGE = 1  
   FFTipcbsrc          : > RAML62,     PAGE = 1
   
   /* Allocate IQ math areas: */
#if defined(RAM)
   IQmath              : > RAML0L1,    PAGE = 0                  /* Math Code */
#elif defined(FLASH)
