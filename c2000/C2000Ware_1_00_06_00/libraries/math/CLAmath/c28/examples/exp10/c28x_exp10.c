...
#elif  defined (F28004x) || defined (F2838x)
#include "driverlib.h"
#endif
#include "CLAmath.h"
...
// Prototypes
//
#if  defined (F28004x) || defined (F2838x)
...
void test_report(void)
{
    ...
    {
        //
        // Verify CLA Task 1 CLAexp10f() function
        //
        fError1[i] = fabs(resExpected[i] - y1[i]);
        ...
        //
        fError2[i] = fabs(resExpected[i] - y2[i]);
