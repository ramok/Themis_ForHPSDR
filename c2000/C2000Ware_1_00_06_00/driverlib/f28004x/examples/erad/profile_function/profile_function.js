...
debugSession.memory.writeData(Memory.Page.DATA,
                              EnhancedDebugGlobalRegs + GLBL_OWNER,
                              OWNER_DEBUGGER,
                              DATA_SIZE_16);
...
var counter1Status =
    debugSession.memory.readData(Memory.Page.DATA,
                                 EnhancedDebugCounter1Regs + CTM_STATUS,
                                 DATA_SIZE_16);

var counter2Status =
    debugSession.memory.readData(Memory.Page.DATA,
                                 EnhancedDebugCounter2Regs + CTM_STATUS,
                                 DATA_SIZE_16);
   ...
   (0 == (counter2Status & CTM_STATUS_M)))
{
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP1Regs + HWBP_CLEAR,
                                  0x1,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP2Regs + HWBP_CLEAR,
                                  0x1,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP3Regs + HWBP_CLEAR,
                                  0x1,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP4Regs + HWBP_CLEAR,
                                  0x1,
                                  DATA_SIZE_16);
    ...
    //
    var startFIRFunc = debugSession.symbol.getAddress("performFIR");
    var endFIRFunc = getFuncEndAddress("performFIR");

    //
    // Get the start and end addresses of the sorting function "sortMax"
    //
    var startSortFunc = debugSession.symbol.getAddress("sortMax");
    var endSortFunc = getFuncEndAddress("sortMax");

    //
    // Set two hardware breakpoints at the start and end of performFIR
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP1Regs + HWBP_REF,
                                  startFIRFunc,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP2Regs + HWBP_REF,
                                  endFIRFunc,
                                  DATA_SIZE_32);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP3Regs + HWBP_REF,
                                  startSortFunc,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP4Regs + HWBP_REF,
                                  endSortFunc,
                                  DATA_SIZE_32);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP1Regs + HWBP_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP2Regs + HWBP_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP3Regs + HWBP_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugHWBP4Regs + HWBP_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugGlobalRegs + GLBL_CTM_RESET,
                                  0x3,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_COUNT,
                                  0x0,
                                  DATA_SIZE_32);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_MAX_COUNT,
                                  0x0,
                                  DATA_SIZE_32);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_CLEAR,
                                  0x3,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_REF,
                                  0x0,
                                  DATA_SIZE_32);

    //
    // Configure CTM_1 to count performFIR execution cycles
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_INPUT_SEL,
                                  0x0800,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter1Regs + CTM_CNTL,
                                  0x004,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter2Regs + CTM_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter2Regs + CTM_MAX_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter2Regs + CTM_CLEAR,
                                  0x3,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter2Regs + CTM_INPUT_SEL,
                                  0x1880,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter2Regs + CTM_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);
    ...
    var enableCounter =
        debugSession.memory.readData(Memory.Page.DATA,
                                     EnhancedDebugGlobalRegs + GLBL_ENABLE,
                                     DATA_SIZE_16);
