...
var counter3Status =
    debugSession.memory.readData(Memory.Page.DATA,
                                 EnhancedDebugCounter3Regs + CTM_STATUS,
                                 DATA_SIZE_16);

var counter4Status =
    debugSession.memory.readData(Memory.Page.DATA,
                                 EnhancedDebugCounter4Regs + CTM_STATUS,
                                 DATA_SIZE_16);
   ...
   (0 == (counter4Status & CTM_STATUS_M)))
{
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter3Regs + CTM_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter3Regs + CTM_MAX_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter3Regs + CTM_CLEAR,
                                  0x3,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter3Regs + CTM_INPUT_SEL,
                                  0x0001,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter3Regs + CTM_CNTL,
                                  0x0008,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter4Regs + CTM_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter4Regs + CTM_MAX_COUNT,
                                  0x0,
                                  DATA_SIZE_32);

    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter4Regs + CTM_CLEAR,
                                  0x3,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter4Regs + CTM_INPUT_SEL,
                                  0x0640,
                                  DATA_SIZE_16);
    ...
    //
    debugSession.memory.writeData(Memory.Page.DATA,
                                  EnhancedDebugCounter4Regs + CTM_CNTL,
                                  0x0004,
                                  DATA_SIZE_16);
