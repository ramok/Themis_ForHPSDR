                  ...
                  unsigned short usFeature)
{
    ...
    writeShort(&(SetupPacket.wValue), usFeature);
    writeShort(&(SetupPacket.wIndex), ucPort);
                 ...
                 unsigned short *pusPortStatus, unsigned short *pusPortChange)
{
    ...
    writeShort(&(SetupPacket.wIndex), (unsigned short)ucPort);
    writeShort(&(SetupPacket.wLength), 4);
...
GetHubDescriptor(tUsbHubDescriptor *psDesc)
{
    ...
    writeShort(&(SetupPacket.wValue), (USB_DTYPE_HUB << 8));
    writeShort(&(SetupPacket.wIndex), 0);
    writeShort(&(SetupPacket.wLength), sizeof(tUsbHubDescriptor));
