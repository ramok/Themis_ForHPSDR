...
#define INT_HRCAP1INT           0x47        //High Resolution Capture Interrupt 1
#define INT_HRCAP2INT           0x48        //High Resolution Capture Interrupt 2

#define INT_QEP1INT             0x51        //Quadrature Interrupt 1
#define INT_QEP2INT             0x52        //Quadrature Interrupt 2
#define INT_HRCAP3INT           0x54        //High Resolution Capture Interrupt 3
#define INT_HRCAP4INT           0x55        //High Resolution Capture Interrupt 4
